...
public abstract class Cliente implements Serializable, UserDetails {
    ...
    public int hashCode() {
        ...
        hash = 83 * hash + Objects.hashCode(getDocumento());
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(getDocumento(), other.getDocumento())) {
            return false;
        }
